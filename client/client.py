...
class RunningScreen(QtWidgets.QDialog, Ui_Running_screen):
	...
	def __init__(self):
		...
		self.detection_graph, self.category_index = OD.load_image()
	...
	def transToPixmap(self):
		...
		img_url = 'http://' + str(self.queryImage.host) + ':' + str(self.queryImage.port) + str(self.queryImage.argv)
		OD.object_detection_for_snapshot(self.detection_graph, self.category_index,img_url)
		return pixmap
